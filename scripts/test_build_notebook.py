...
class BuildNotebookTest(unittest.TestCase):
    ...
    def test_tool_eval_note_records_execution_and_update(self):
        ...
        self.assertIsNone(meta['promoted_asset_url'])
        self.assertFalse(meta['show_promotion'])
        self.assertIn('실제 실행 결과', body)
        self.assertIn('https://devsnack-blog.vercel.app/benchmarks', body)
